    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <div class="social-links mb-3">
          <a href="#" class="text-white mx-2" style="display: inline-block; width: 40px; height: 40px; border: 1px solid rgba(255,255,255,0.3); border-radius: 50%; display: inline-flex; align-items: center; justify-content: center;"><i class="fab fa-facebook-f"></i></a>
